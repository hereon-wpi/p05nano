...
class cPMACgui(QtGui.QMainWindow):
    def __init__(self, parent = None, blockdirectmovements=True, devices=[], groups=[], name='PMAC motor GUI'):
        ...
        QtCore.QObject.connect(self.but_pmac_connection, QtCore.SIGNAL('clicked()'), self.clickButtonConnectPMACs)
...
def PMACgui():
    ...
    gui = cPMACgui(parent=QtGui.QMainWindow(), devices=getPMACmotorList(), groups=getPMACmotorGroups())
