...
def getPMACmotorUserGroups():
    groups = []
    groups.append(['Cone-beam aperture system', 3, '#CCDDEE'])
    groups.append(['Optics SpaceFab (condenser optics)', 3, '#CCCCEE'])
    groups.append(['Optics SpaceFab (objective optics)', 3, '#CCEEEE'])
    groups.append(['Sample stage (substructure)', 3, '#EEEECC'])
    groups.append(['Sample positioning SpaceFab', 3, '#EED6BF']) #EECFBF
    return groups
